...
public class BigAuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler{
	...
	public void onAuthenticationSuccess(HttpServletRequest request,	HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        if (savedRequest == null) {
            ...
            //to change the code of targetUrl back to "ISO-8859-1", other wise the chinese user name will be lost by method sendRedirect
            byte tByteAry[];
            ...
            //we can not use following way to display the personal page (to avoid the encoding error of targetUrl) because [1] thrown exception when calling tOwner.getListento();
            //[2] even if I can resolve the exception, the following method return a string as url to display the page, while here we don't know how to handle the string.
