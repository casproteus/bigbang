...
public class RemarkAppender extends JFrame implements ActionListener, ListSelectionListener, WindowListener {
    ...
    private List<Twitter> getAllTopics() {
        ...
        WebResource webResource = client.resource(path + "1210_syncdb_bg"); // have to add an value: /{pCommand}, to
                                                                            // distinguish
    ...
    private List<Remark> getAllRemarks() {
        Client client = Client.create(new DefaultClientConfig());
        WebResource webResource = client.resource(path + "1210_syncdb_rm"); // have to add an value: /{pCommand}, to
                                                                            // distinguish
        webResource.accept("application/json"); // other methods in controller.
    ...
    private List<Remark> getReleventRemarks(
            Twitter tw) {
