...
privileged aspect UserAccount_Roo_JavaBean {
    ...
    public void UserAccount.setName(
            String name) {
        this.name = name;
    }
    ...
    public void UserAccount.setEmail(
            String email) {
        this.email = email;
    }
    ...
    public void UserAccount.setPassword(
            String password) {
    ...
    public void UserAccount.setDescription(
            String description) {
    ...
    public void UserAccount.setPrice(
            int price) {
        this.price = price;
    }
    ...
    public void UserAccount.setLayout(
            String layout) {
        this.layout = layout;
    }
    ...
    public void UserAccount.setBalance(
            int balance) {
    ...
    public void UserAccount.setTheme(
            int theme) {
        this.theme = theme;
    }
    ...
    public void UserAccount.setStatus(
            int status) {
        this.status = status;
    }
    ...
    public void UserAccount.setNewMessageAmount(
    ...
    public void UserAccount.setNoteLayout(
            String noteLayout) {
    ...
    public void UserAccount.setListento(
            Set<UserAccount> listento) {
