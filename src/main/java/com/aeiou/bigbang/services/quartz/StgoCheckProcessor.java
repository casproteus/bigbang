...
public class StgoCheckProcessor {
    ...
    public synchronized void stgoCheck() {
        ...
        for (int i = 0; i < urls.length; i++) {
            ...
            WebResource webResource = client.resource(tURL + "/stgocheck/stgo"); // have to add an value: /{pCommand},
                                                                                 // to distinguish
            ...
            try {
                ...
                BigUtil.sendMessage("info@sharethegoodones.com", "SERVER STOPED!--" + tURL, "tao@sharethegoodones.com",
