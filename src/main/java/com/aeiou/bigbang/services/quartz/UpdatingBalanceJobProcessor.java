...
public class UpdatingBalanceJobProcessor {
    ...
    /**
     * this will be activated by the Spring Quarz 1.get all user out into list. 2.go through each user, and get all the
     * user he's listening. replace them with the element in the list 3.go through this list, for each listened user,
     * fetch out his salary. 4.give him his salary.(for now we don't allow user to change his salary, later when we
     * allow, we'll send email to his emaployers. 5.remove the money from the employee 6.save every one back to db
     */
