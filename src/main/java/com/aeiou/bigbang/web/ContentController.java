...
public class ContentController {
    ...
    public String create(
        ...
        if (StringUtils.isNotBlank(content.getAddingTagFlag())) {
            ...
            return createForm_Tag(uiModel, httpServletRequest, content.getTitle(), content.getSourceURL(),
                    tBigTag != null ? tBigTag.getTagName() : null);
        }
