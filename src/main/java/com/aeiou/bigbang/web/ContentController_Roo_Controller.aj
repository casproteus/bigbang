...
privileged aspect ContentController_Roo_Controller {
    ...
    public String ContentController.show(
    ...
    public String ContentController.delete(
            @PathVariable("id") Long id,
    ...
    void ContentController.addDateTimeFormatPatterns(
            Model uiModel) {
        uiModel.addAttribute("content_markdate_date_format",
                DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }

    void ContentController.populateEditForm(
            Model uiModel,
            Content content) {
    ...
    String ContentController.encodeUrlPathSegment(
            String pathSegment,
