...
privileged aspect MessageController_Roo_Controller {
    ...
    public String MessageController.createForm(
            Model uiModel) {
    ...
    public String MessageController.show(
    ...
    public String MessageController.update(
    ...
    public String MessageController.updateForm(
            @PathVariable("id") Long id,
            Model uiModel) {
    ...
    public String MessageController.delete(
            @PathVariable("id") Long id,
    ...
    void MessageController.addDateTimeFormatPatterns(
            Model uiModel) {
        uiModel.addAttribute("message_posttime_date_format",
                DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }

    void MessageController.populateEditForm(
            Model uiModel,
            Message message) {
    ...
    String MessageController.encodeUrlPathSegment(
            String pathSegment,
            HttpServletRequest httpServletRequest) {
