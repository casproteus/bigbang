...
privileged aspect MessageController_Roo_Controller_Json {
    ...
    @ResponseBody
    public ResponseEntity<String>MessageController.showJson(
    ...
    public ResponseEntity<String>MessageController.createFromJson(
        ...
        try {
            ...
            headers.add("Location",
                    uriBuilder.path(a.value()[0] + "/" + message.getId().toString()).build().toUriString());
    ...
    public ResponseEntity<String>MessageController.createFromJsonArray(
            @RequestBody String json) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
    ...
    public ResponseEntity<String>MessageController.updateFromJson(
            @RequestBody String json,
            @PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
    ...
    public ResponseEntity<String>MessageController.deleteFromJson(
            @PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
